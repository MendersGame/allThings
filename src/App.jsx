...
import PeanutbutterThings from './pages/PeanutbutterThings/PeanutButterThings'
...
const App = () => {
  ...
  const kelseasThings = [
    {
      name: "Peanut-Butter",
      image: "https://imgur.com/gallery/3ORiwnu",  
      attributes: ["Adorable", "Chaotic", "Snuggly", "Purrfect"],
    },
  ]
  ...
  return (
    <Routes>
      ...
      />
      <Route
        path="/the-peanutbutter-things"
        element={<PeanutbutterThings things={kelseasThings} />}
      />
    </Routes>
  )
}
